...
Future<void> _runSmallScreenTest(WidgetTester tester) async {
...
void _runLargeScreenTest(WidgetTester tester) {
  ...
  expect(identical(onboardingRowWidget, loginRowWidget), isTrue,
      reason: 'OnboardingPage and LoginPage must share the same Row ancestor');
