...
class _BreakdownByDayChartState extends State<BreakdownByDayChart> {
  ...
  Widget getLeftTitles(double value, TitleMeta meta) {
    var itineraries =
        RepositoryProvider.of<TripManagement>(context).activeTrip!.itineraries;
    var index = value.toInt() % itineraries.length;
    ...
    String text =
        DateFormat('EEE, MMM d').format(itineraries.elementAt(index).day);
