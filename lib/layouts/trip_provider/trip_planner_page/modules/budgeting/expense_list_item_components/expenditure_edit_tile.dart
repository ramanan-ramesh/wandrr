...
class ExpenditureEditTile extends StatefulWidget {
  ...
  ExpenditureEditTile(
      {super.key,
      required ExpenseUpdator expenseUpdator,
      this.callback,
...
class _ExpenditureEditTileState extends State<ExpenditureEditTile>
  ...
  static const double _heightPerItem = 45;
...
class _PaidByTab extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var currentUserName = RepositoryProvider.of<PlatformDataRepository>(context)
        .appLevelData
        .activeUser!
        .userName;
                ...
                child: Material(
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      ...
                      style: TextStyle(
                          color:
                              widget.contributorsVsColors[contributorVsColor]),
                    ),
                    leading: Container(
                      width: 30,
                      height: 30,
