              ...
              children: [
                ...debtDataList.map(
                  (e) => Row(
                    ...
                    children: [
                      FittedBox(
                        child: _buildContributorName(e.owedBy, currentUserName,
                            contributorsVsColors[e.owedBy]!, appLocalizations),
                      ),
                      FittedBox(
                        child: Text(context.localizations.needsToPay),
                      ),
                      FittedBox(
                        child: _buildContributorName(e.owedTo, currentUserName,
                            contributorsVsColors[e.owedTo]!, appLocalizations),
                      ),
                      FittedBox(
