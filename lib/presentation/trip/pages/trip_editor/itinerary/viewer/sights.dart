...
class ItinerarySightsViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TripEntityUpdateHandler<ItineraryPlanData>(
      shouldRebuild: (beforeUpdate, afterUpdate) {
        var isItineraryPlanDataUpdated = beforeUpdate.day.isOnSameDayAs(day) ||
            afterUpdate.day.isOnSameDayAs(day);
        if (isItineraryPlanDataUpdated) {
          var sightsBeforeUpdate = beforeUpdate.sights;
          var sightsAfterUpdate = afterUpdate.sights;
                  ...
                  child: DecoratedBox(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        borderRadius: BorderRadius.circular(14),
                        splashColor: Theme.of(c)
                            .colorScheme
                            .primary
                            .withValues(alpha: 0.10),
                        highlightColor: Theme.of(c)
                            .colorScheme
                            .primary
  ...
  Widget _buildShimmerSkeleton(BuildContext context) {
    Widget shimmer(double height) => Padding(
          padding: const EdgeInsets.only(bottom: _kSpacingMedium),
