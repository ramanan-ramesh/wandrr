...
class Location with EquatableMixin implements LocationFacade {
  @override
  String? id;
  ...
  @override
  LocationContext get context => _context;
  final LocationContext _context;
  ...
  @override
  Map<String, dynamic> toJson() {
    var geoPoint = GeoPoint(_latitude, _longitude);
    return {
  ...
  Location clone() {
    return Location(
        latitude: _latitude, longitude: _longitude, context: _context.clone());
  }
  ...
  @override
  List<Object?> get props => [longitude, latitude, context, id];
}
